...
export default function Home() {
  return (
    <div >
      <div>
        <h1 className="font-extrabold text-[30px] text-center mt-3 bg-green-300">Understanding Web Rendering Methods: SSR, CSR, SSG, and ISR</h1>
        ...
        <br />
      <div>
        <h1 className="font-extrabold text-[30px] ml-2 bg-red-300">1. Server-Side Rendering (SSR)</h1>
        <div>
      ...
      <hr/>
      <div>
        <h1 className="font-extrabold text-[30px] mt-10 ml-2 bg-yellow-400">2. Client-Side Rendering (CSR)</h1>
        <div>
          <h2 className="pl-8 font-bold">Definition:</h2>
      ...
      <hr/>
      <div>
        <h1 className="font-extrabold text-[30px] mt-10 ml-2 bg-pink-400">3. Static Site Generation (SSG)</h1>
        <div>
          <h2 className="pl-8 font-bold">Definition:</h2>
      ...
      <hr/>
      <div>
        <h1 className="font-extrabold text-[30px] mt-10 ml-2 bg-gray-400 ">4. Incremental Static Regeneration (ISR)</h1>
        <div>
          <h2 className="pl-8 font-bold">Definition:</h2>
